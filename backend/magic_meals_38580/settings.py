"""
Django settings for magic_meals_38580 project.
...
ROOT_URLCONF = 'magic_meals_38580.urls'
...
WSGI_APPLICATION = 'magic_meals_38580.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "magic_meals_38580 API",
    "DESCRIPTION": "API documentation for magic_meals_38580 App",
    "VERSION": "v1",
}
